...
RARITY = {
    "RECON":    dict(idx=0, name="شناسایی سبک", cls="DECLASSIFIED", mult=1.00),
    "RARE":     dict(idx=1, name="کمیاب", cls="RESTRICTED", mult=1.16),
    "ELITE":    dict(idx=2, name="الیت", cls="CONFIDENTIAL", mult=1.34),
    "ALPHA":    dict(idx=3, name="آلفا", cls="SECRET", mult=1.58),
    "LEGENDARY": dict(idx=4, name="افسانه‌ای", cls="OMEGA-LEVEL", mult=1.86),
    "OMEGA":    dict(idx=5, name="کلاسیفای‌د/امگا", cls="EYES ONLY", mult=2.10),
}
...
ROWS = [
 ("godzilla", "Godzilla", "godzilla", "godzilla", "LEGENDARY", 5, 9800, 640, 620, 96, 620, 430, 300, 84, 18, 560,
  ...
  "Heisei/MonsterVerse", "119m", "99630t", "پادشاه تایتان‌ها. انرژی‌اش بی‌پایان نیست، اما هر نفسش یک شهر را عوض می‌کند."),
 ("kong", "Kong", "kong", "monsterverse", "ALPHA", 4, 7600, 610, 470, 168, 420, 520, 190, 92, 34, 300,
  ...
  "Skull Island", "102m", "—"  , "مغز می‌جنگد، نه فقط بازو. سپرِ نبردِ هوشمند."),
 ("mothra", "Mothra", "mothra", "kaiju", "LEGENDARY", 4, 6200, 470, 520, 182, 560, 600, 240, 90, 40, 520,
  ...
  "Mothra vs. Godzilla", "100m", "—"  , "نگهبانِ زمین؛ وقتی می‌میرد، از تخم بازمی‌گردد."),
 ("king_ghidorah", "King Ghidorah", "ghidorah", "kaiju", "LEGENDARY", 5, 9100, 680, 520, 176, 580, 460, 280, 86, 26, 380,
  ...
  "Ghidorah, the Three-Headed Monster", "158m", "141966t", "هر سر یک اراده دارد؛ طوفان، اثر جانبی است."),
 ("rodan", "Rodan", "rodan", "kaiju", "ELITE", 3, 4800, 470, 340, 244, 380, 300, 130, 88, 46, 260,
  ...
  "Rodan", "70m", "—"  , "قبل از اینکه صدا را بشنوی، بال‌هایش رد شده است."),
 ("mechagodzilla", "Mechagodzilla", "mecha", "kaiju", "LEGENDARY", 5, 8800, 660, 700, 130, 700, 560, 60, 96, 14, 560,
  ...
  "Godzilla vs. Mechagodzilla", "100m", "—"  , "هیچ دردی را حس نمی‌کند؛ اما داغ می‌کند. Overheat تنها دشمن اوست."),
 ("anguirus", "Anguirus", "anguirus", "kaiju", "RARE", 2, 4200, 380, 520, 138, 300, 240, 190, 82, 28, 300,
  ...
  "Godzilla Raids Again", "60m", "—"  , "سپر زنده‌ی گودزیلا؛ وقتی کنار اوست، پادشاه نمی‌افتد."),
 ("destoroyah", "Destoroyah", "destoroyah", "kaijs", "LEGENDARY", 5, 7400, 640, 430, 210, 520, 480, 300, 90, 40, 340,
  ...
  "Godzilla vs. Destoroyah", "120m", "—"  , "از ریزسلول‌های مرگ ساخته شده و در هر فاز، شکل را عوض می‌کند."),
 ("spacegodzilla", "SpaceGodzilla", "spacegod", "godzilla", "LEGENDARY", 5, 8200, 620, 600, 150, 660, 470, 260, 88, 24, 520,
  ...
  "Godzilla vs. SpaceGodzilla", "100m", "—"  , "هر بلور، یک آینه؛ هر آینه، یک مرگ."),
 ("biollante", "Biollante", "biollante", "kaiju", "ELITE", 3, 6000, 470, 460, 96, 460, 520, 420, 74, 18, 400,
  ...
  "Godzilla vs. Biollante", "80m", "—"  , "نیمی گل، نیمی کابوس؛ ریشه‌هایش در DNA گودزیلا گره خورده‌اند."),
 ("gigan", "Gigan", "gigan", "kaiju", "ELITE", 3, 5400, 540, 430, 190, 480, 360, 150, 90, 30, 380,
  ...
  "Godzilla vs. Gigan", "65m", "—"  , "سازندگانش او را برای کشتن پادشاه ساختند؛ پادشاه زنده ماند."),
 ("hedorah", "Hedorah", "hedorah", "kaiju", "ELITE", 4, 5200, 430, 500, 132, 460, 400, 380, 78, 26, 460,
  ...
  "Godzilla vs. the Sea Monster", "—"  , "—"  , "محققِ آلودگی؛ از دود بزرگ شد و از خشکی می‌ترسد."),
 ("megalon", "Megalon", "megalon", "kaiju", "RECON", 1, 3000, 300, 300, 118, 220, 220, 130, 76, 24, 200,
  ...
  "Godzilla vs. Megalon", "55m", "—"  , "نماینده‌ی جهان زیرین، با دست‌های مته‌ای."),
 ("king_caesar", "King Caesar", "caesar", "kaiju", "RARE", 2, 4400, 380, 600, 140, 320, 380, 180, 80, 30, 420,
  ...
  "Godzilla vs. Mechagodzilla", "30m", "—"  , "مجسمه‌ای که فقط وقتی شهر در خطر است، زنده می‌شود."),
 ("titanosaurus", "Titanosaurus", "titanosaurus", "kaiju", "RARE", 2, 4300, 400, 360, 126, 300, 280, 160, 82, 26, 300,
  ...
  "The Terror of Godzilla", "60m", "—"  , "فریادش استخوان را می‌لرزاند؛ در آب، تقریباً مغلوب‌ناپذیر."),
 ("battra", "Battra", "battra", "kaiju", "ALPHA", 4, 5600, 520, 470, 208, 480, 460, 240, 90, 42, 400,
  ...
  "Godzilla vs. Mothra", "68m", "—"  , "برادر تاریک مothra؛ عدالت را با انتقام می‌آمیزد."),
 ("jet_jaguar", "Jet Jaguar", "jet", "kaiju", "RARE", 1, 2800, 300, 260, 260, 380, 480, 60, 92, 52, 240,
  ...
  "Godzilla vs. Megalon", "60m→40m", "—"  , "رباتِ آزاد؛ اندازه را خودش انتخاب می‌کند."),
 ("moguera", "M.O.G.U.E.R.A.", "moguera", "kaiju", "RARE", 2, 3400, 340, 420, 150, 420, 440, 70, 88, 22, 360,
  ...
  "Rebirth of Mothra III", "50m", "—"  , "تانکِ مداری MONARCH؛ در جنوبگان متولد شده."),
 ("baragon", "Baragon", "baragon", "kaiju", "RECON", 1, 2600, 280, 280, 160, 220, 240, 130, 80, 36, 200,
  ...
  "Frankenstein vs. Baragon", "45m", "—"  , "گوش‌هایش را می‌بندد، سپس زمین را می‌شکافد."),
 ("kumonga", "Kumonga", "kumonga", "kaiju", "RECON", 1, 2400, 300, 240, 172, 200, 220, 140, 84, 40, 180,
 ...
 ("kamacuras", "Kamacuras", "kamacuras", "kaiju", "RECON", 1, 2000, 260, 200, 214, 180, 180, 120, 86, 48, 140,
 ...
 ("ebirah", "Ebirah", "ebirah", "kaiju", "RARE", 2, 3600, 380, 340, 128, 260, 200, 150, 78, 24, 280,
 ...
 ("manda", "Manda", "manda", "kaiju", "RARE", 2, 4000, 360, 320, 140, 280, 320, 170, 80, 30, 280,
 ...
 ("gorosaurus", "Gorosaurus", "gorosaurus", "kaiju", "RECON", 1, 2900, 320, 280, 176, 220, 200, 130, 82, 38, 200,
 ...
 ("varan", "Varan", "varan", "kaiju", "RECON", 1, 2300, 280, 240, 220, 200, 240, 130, 84, 46, 160,
 ...
 ("orga", "Orga", "orga", "kaiju", "ALPHA", 4, 6000, 560, 430, 156, 420, 380, 260, 84, 26, 380,
 ...
 ("megaguirus", "Megaguirus", "megaguirus", "kaiju", "ELITE", 3, 3800, 420, 300, 230, 360, 320, 190, 88, 44, 260,
 ...
 ("monster_x", "Monster X", "monsterx", "kaiju", "LEGENDARY", 5, 7200, 600, 640, 110, 620, 500, 300, 86, 12, 560,
 ...
 ("keizer_ghidorah", "Keizer Ghidorah", "keizer", "kaiju", "OMEGA", 5, 9400, 700, 560, 170, 700, 520, 380, 88, 24, 520,
 ...
 ("skar_king", "Skar King", "skar", "monsterverse", "OMEGA", 5, 8600, 660, 540, 190, 600, 480, 300, 88, 30, 460,
 ...
 ("shimo", "Shimo", "shimo", "monsterverse", "LEGENDARY", 5, 8000, 620, 560, 140, 580, 440, 320, 84, 20, 520,
 ...
 ("suko", "Suko", "suko", "monsterverse", "RECON", 1, 2100, 260, 220, 226, 180, 300, 140, 88, 52, 140,
 ...
 ("tiamat", "Tiamat", "tiamat", "monsterverse", "ELITE", 3, 5000, 440, 400, 208, 340, 300, 200, 84, 40, 320,
 ...
 ("scylla", "Scylla", "scylla", "monsterverse", "ELITE", 3, 5200, 430, 440, 120, 320, 300, 220, 78, 22, 360,
 ...
 ("behemoth", "Behemoth", "behemoth", "monsterverse", "ELITE", 2, 5400, 420, 480, 110, 300, 320, 210, 76, 18, 340,
 ...
 ("methuselah", "Methuselah", "methuselah", "monsterverse", "ELITE", 3, 5000, 400, 460, 118, 360, 420, 240, 78, 20, 380,
 ...
 ("amhuluk", "Amhuluk", "amhuluk", "monsterverse", "RARE", 2, 4200, 380, 360, 128, 280, 300, 190, 78, 24, 280,
 ...
 ("abaddon", "Abaddon", "abaddon", "monsterverse", "ELITE", 3, 4800, 440, 420, 146, 300, 340, 200, 80, 26, 320,
 ...
 ("muto_prime", "MUTO Prime", "muto", "monsterverse", "ALPHA", 4, 6000, 520, 420, 216, 400, 360, 210, 88, 42, 320,
 ...
 ("skullcrawler", "Skullcrawler", "skullcrawler", "monsterverse", "RECON", 1, 2600, 320, 220, 190, 180, 200, 150, 82, 40, 160,
 ...
 ("warbat", "Warbat", "warbat", "monsterverse", "RECON", 1, 2000, 280, 200, 240, 180, 220, 130, 86, 50, 150,
 ...
 ("muto_minion", "MUTO Brood", "muto", "monsterverse", "RECON", 1, 2200, 300, 240, 200, 200, 200, 140, 80, 44, 170,
...
_DEFAULT_TAIL = dict(origin="Toho / MonsterVerse", h="—", w="—",
    ...
    for fn in sorted(os.listdir(d)):
        ...
        for item in (blob if isinstance(blob, list) else [blob]):
            ...
            if tid in TITANS:
                ...
                base.setdefault("h", "—")
                base.setdefault("w", "—")
                base.setdefault("lore", "پرونده‌ی تازه — در حال راستی‌آزمایی MONARCH.")
                TITANS[tid] = base
            n += 1
    if n:
